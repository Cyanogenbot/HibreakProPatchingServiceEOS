...
def update_vndk_rc():
    ...
    service_entries = [
        ...
        "    exec_background u:r:phhsu_daemon:s0 root -- /system/bin/chmod 644 /sys/devices/platform/11d01000.i2c7/i2c-7/7-0036/lm3630a_cold_light\n",
        "    exec_background u:r:phhsu_daemon:s0 root -- /system/bin/chown root:root /sys/devices/platform/11d01000.i2c7/i2c-7/7-0036/lm3630a_cold_light\n",
        "    exec_background u:r:phhsu_daemon:s0 root -- /system/bin/chcon u:object_r:sysfs_leds:s0 /sys/devices/platform/11d01000.i2c7/i2c-7/7-0036/lm3630a_cold_light",
        "    exec_background u:r:phhsu_daemon:s0 root -- /system/bin/chmod 644 /sys/devices/platform/11d01000.i2c7/i2c-7/7-0036/lm3630a_warm_light\n",
        "    exec_background u:r:phhsu_daemon:s0 root -- /system/bin/chown root:root /sys/devices/platform/11d01000.i2c7/i2c-7/7-0036/lm3630a_warm_light\n",
        "    exec_background u:r:phhsu_daemon:s0 root -- /system/bin/chcon u:object_r:sysfs_leds:s0 /sys/devices/platform/11d01000.i2c7/i2c-7/7-0036/lm3630a_warm_light",
